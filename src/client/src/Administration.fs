...
let allTabs = [ UserPayment; Orders; Users; Products; OrderStatistics; DataExport; Settings ]
...
let Administration activeTab =
    ...
    let abortButton =
        Html.a [ prop.className "btn"; prop.href (Router.format ("")); prop.text "Abbrechen" ]
    ...
    React.fragment [
        ...
        | NoAuthKeyProvided ->
            Html.div [
                ...
                prop.children [ View.authForm; abortButton ]
            ]
        | InvalidAuthKeyProvided ->
            Html.div [
                prop.className "flex flex-col items-center gap-4 p-8"
        ...
        | AuthKeyProvided(Error error) ->
            Html.div [
                ...
                prop.children [
                    ...
                    Html.div [ prop.className "flex flex-col items-center"; prop.children [ abortButton ] ]
                ]
            ]
        | AuthKeyProvided(Ok authKey) ->
            Html.div [
                ...
                prop.children [
                                            ...
                                            Html.a [
                                                prop.classes [
                                                    ...
                                                    if tab = activeTab then
                                                        "border-b border-musi-blue text-musi-blue"
                                                ]
                    ...
                    | UserPayment ->
                        UserPaymentAdministration.UserPaymentAdministration
                            (Some authKey)
                            (fun () -> setAuthKey InvalidAuthKeyProvided)
                            setTabMenuItems
                    | Orders ->
                        OrderAdministration.OrderAdministration
                            (Some authKey)
                            (fun () -> setAuthKey InvalidAuthKeyProvided)
                            setTabMenuItems
                    | Users ->
                    ...
                    | DataExport ->
                        DataExport.DataExport
                            ...
                            setTabMenuItems
                    | Settings ->
                        Settings.Settings (Some authKey) (fun () -> setAuthKey InvalidAuthKeyProvided) setTabMenuItems
                ]
            ]
            ...
            Html.div [
                ...
                prop.children [
                    Html.div [
                        ...
                        prop.children [
                            Html.div [ prop.className "flex items-center gap-2"; prop.ref tabMenuContainerRef ]
                            Html.div [
